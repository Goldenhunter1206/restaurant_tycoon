...
var SCREENS: Dictionary = {
	...
	&"underworld": load("res://scripts/ui/screens/underworld_screen.gd"),
	&"security": load("res://scripts/ui/screens/security_screen.gd"),
	&"city_hall": load("res://scripts/ui/screens/city_hall_screen.gd"),
}
